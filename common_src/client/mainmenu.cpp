...
int MainMenu::Start() {
    ...
    while (response == 0) {
        ...
        renderer.Copy(
        SDL2pp::Texture(renderer,"../resources/backgrounds/War1/Bright/War.png"),
        SDL2pp::NullOpt,
...
MainMenu::MainMenu() {
    this->boton_play("PLAY",SDL2pp::Rect(
        (1920/2)-200,(1080/2)-10-100,400,100
    ));
    this->boton_quit("QUIT",SDL2pp::Rect(
        (1920/2)-200,(1080/2)+10,400,100
    ));
}
